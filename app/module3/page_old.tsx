...
// allModules.map((modules: any) => console.log("modules: ", modules));
export default async function ModulePage3() {
  return (
    <>
    {/* {
      // client.getContentType('module3')
        ...
        >
          ...
          >
            ...
            >
              ...
              {/* {modules.swatchCollection.items.swatchName && (
                <>
                  {modules.swatchCollection.items.map((swatch: any) => ( 
                    <div
                      key={swatch.sys.id}
                      className="mt-5"
                    >
                      <div className="text-zinc-800 text-xl/relaxed lg:text-base/relaxed xl:text-base/relaxed dark:text-zinc-400">
                        {swatch.swatchName}
                      </div>
                    </div>  
                  ))}
